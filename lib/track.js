...
const TRACK_URL = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/track`;
const HEADERS = {
...
/* First-party pageview + presence tracking for the public site. Records a
   "view" on each route change and sends a lightweight "ping" heartbeat so the
   admin live map can tell who is on the site right now. */
